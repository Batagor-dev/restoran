@php
    $sub_title = ($breadcrumb = Breadcrumbs::current()) ? $breadcrumb->title : 'Product Stocks';
...
<div class="space-y-8 pb-12">
    <x-ui.card>
        <div class="flex items-center justify-between mb-4">
            ...
            @can('Product Stock Create')
                <x-ui.button href="{{ route('product-stocks.create') }}" color="primary" size="sm">
