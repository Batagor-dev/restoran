...
class ProductCategoryDataTable extends DataTable
{
        ...
        return datatables()
            ...
            ->addColumn('action', function ($row) {
                ...
                if (auth()->user()->can('Product Category Update')) {
                    $edit = '<a href="'.route('product_categories.edit', $row->uuid).'"
                ...
                if (auth()->user()->can('Product Category Delete')) {
                    $delete = '
                        <form action="'.route('product_categories.destroy', $row->uuid).'"
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('description')->title('Description')->addClass('px-4 py-3 border-b border-slate-200 text-slate-700'),
